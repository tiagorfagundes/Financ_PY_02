...
| 07 | Constituição de empresa (veículo) | **Ley 6480/2020** (EAS); Código Civil (SA/SRL); **Ley 117/91 + 5542/15** (inversão estrangeira) | SUACE / Registro Público / SET / IPS |
...
### Camada 6 — Constituição da Empresa / Veículo
- 🏛️ [Camada 6 · Constituição da Empresa](14_constitucion_empresa/00_README_camada6.md) — tipos societários (EAS/SA/SRL/sucursal), processo (SUACE), Casa de Bolsa (SIV) e legislação de estrangeiros (Ley 117/91, 5542/15) *(pasta nº 14)*
